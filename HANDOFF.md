...
- **Prose tension for Sam (pink, not fixed):** the revolutionary's last line in Among the Moai is "'Go on. It's been asking for you.'" pointing at the sixth moai, and the only next step is now taking his rifle. Worth a line that turns the invitation into a condition.

**STATE 2026-09-26, ~03:30 UTC — The French's 3D room is now the passage's own navigation, on branch `claude/scene-closeups-pe93vp` (commit 0cc96ba on top of Astra's graphics lift d244293, which main does not have). Log: project files `scene-closeups/The French room as navigation log 2026-09-26.md`, copy in `scratchpad/scene-closeups-2026-09-25/LOG-room-navigation-2026-09-26.md`. If the html conflicts on merge, take either side and re-run `python3 sync_html.py`; the twee is the truth.**

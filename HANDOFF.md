...
>
> **State at handoff (2026-06-04, all synced + committed):** Lackland's office **music** composed + wired (resumes mid-phrase after the pong game via the new `resumePosition` bed flag); the **"Watch the decider" pre-pong rally animation**; the **Coach & Horses** finished as a full venue (Soho-map pulse + bespoke grimy **Victorian tile friezes** in the gents); office **Linger-only** flow + "Back to Dean Street" labels; and audio-tag cleanup. **Sarah's playthrough notes are all done bar the music.**
>

...
Next: two more strangers (Easter Island replaces Red's corner scene, Pyramid replaces Inis's shop scene); Sam will name and sketch them. Corners left: Wardour/Old Compton, Shaftesbury at Frith. Each needs the same five pieces plus unhooking that world's recognises scene (Red c. 45302, Inis 46176, Lackland 48118, Benito 50368) and its notebook echo variable.

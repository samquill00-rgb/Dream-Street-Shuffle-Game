...
### 18f — STILL OPEN / NEXT
1. **Not verified live:** the `dss:boxreveal` glass-smash timing (18a.4), the lily `.lily-taken` state (18a.7), the birdsong gate (18a.10), the Yeti exit (18a.11). All are simple and were verified statically, but none has been seen running. The scratch-build recipe in 18e makes each a ten-minute job.
